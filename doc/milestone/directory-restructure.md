...
1. ダッシュボード
- [ ] 既存コードの依存関係確認
- [ ] `pages/dashboard/page.tsx` の作成
- [ ] 関連コードの移行
- [ ] ルーティングの更新

2. 認証
- [ ] 認証フローの依存関係確認
- [ ] `pages/auth/page.tsx` の作成
- [ ] 関連コードの移行
- [ ] ルーティングの更新

3. 部屋詳細
- [ ] 部屋情報の依存関係確認
- [ ] `pages/rooms/[id]/page.tsx` の作成
- [ ] 関連コードの移行
- [ ] ルーティングの更新

4. レポート作成
- [ ] レポート機能の依存関係確認
- [ ] `pages/rooms/[id]/report/page.tsx` の作成
- [ ] 関連コードの移行
- [ ] ルーティングの更新
